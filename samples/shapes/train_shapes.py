...
class DrugDataset(utils.Dataset):
    ...
    def load_shapes(self, count, height, width, img_floder, mash_floder, imglist, dataset_root_path):
        # 修改为自己的类别
        self.add_class("shapes", 1, "2lines")
        self.add_class("shapes", 2, "3lines")
        self.add_class("shapes", 3, "4lines")
        #self.add_class("shapes",1,"pole")
        ...
        for i in range(count):
            ...
            #print(cv_img.shape[1],cv_img.shape[0])
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            #if labels[i].find("pole") != -1:
                #labels_from.append("pole")
            if labels[i].find("2lines") != -1:
                labels_from.append("2lines")
            elif labels[i].find("3lines") != -1:
                labels_from.append("3lines")
            elif labels[i].find('4lines') != -1:
                labels_from.append('4lines')
...
# 基础设置
dataset_root_path = "C:/Users/左右飞/Desktop/毕设/new/Mask_RCNN-master--TrainOwerDatset-master/assets"
...
if init_with == "imagenet":
    ...
    model.load_weights('C:/Users/左右飞/Desktop/毕设/new/Mask_RCNN-master--TrainOwerDatset-master/samples/shapes/mask_rcnn_shapes_0070.h5', by_name=True)
